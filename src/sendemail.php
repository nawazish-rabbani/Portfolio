...
$mail->Username = 'contact@nawazish.dev';                 // SMTP username
$mail->Password = 'dTq@*!hWLr6H?GcE';                           // SMTP password
$mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587;                                    // TCP port to connect to

$mail->From = 'contact@nawazish.dev';
$mail->FromName = 'nawazish.dev';
$mail->addAddress('nawazish.bhojani@gmail.com', 'Nawazish Rabbani');     // Add a recipient

$mail->Subject = 'From: '.$email.' Name :'.$name.'';
$mail->Body    = $body;
$mail->AltBody = $body;
